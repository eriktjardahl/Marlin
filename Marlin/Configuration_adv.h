...
#define DISABLE_INACTIVE_Y DISABLE_INACTIVE_X
#define DISABLE_INACTIVE_Z DISABLE_INACTIVE_X  // Set to false if the nozzle will fall down on your printed part when print has finished.
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { MANUAL_FEEDRATE_XYZ, MANUAL_FEEDRATE_XYZ, MANUAL_FEEDRATE_XYZ, 25*60 } // Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define Z_HYBRID_THRESHOLD     X_HYBRID_THRESHOLD
