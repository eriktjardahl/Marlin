...
#define STRING_CONFIG_H_AUTHOR "@brandstaetter, @grbd, @eriktjardahl" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Automata Delta"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_PRINTABLE_RADIUS 119.0  // (mm)
    // Center-to-center distance of the holes in the diagonal push rods.
    #define DELTA_DIAGONAL_ROD 264.5      // (mm)
  ...
  #define DELTA_HEIGHT 258.64             // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 419.2 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -10.86, -6.27, -38.8 }
...
#define Z_AFTER_PROBING             150 // Z position after probing is done
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 0, (Z_MAX_POS -10) }
  //#define NOZZLE_PARK_X_ONLY          // X move only is required to park
  //#define NOZZLE_PARK_Y_ONLY          // Y move only is required to park
  #define NOZZLE_PARK_Z_RAISE_MIN   2   // (mm) Always raise Z by at least this distance
  #define NOZZLE_PARK_XY_FEEDRATE 100   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE NOZZLE_PARK_XY_FEEDRATE // (mm/s) Z axis feedrate (not used for delta printers)
#endif
